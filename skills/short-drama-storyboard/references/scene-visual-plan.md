...
写完镜头后按预计入剪时间连读整场：每段时间是否兑现已接受的观看意图？重复或停留可以承载
信息、表演、悬念，也可以让动作质感与声音韵律本身成为观看对象；是否压缩取决于其职责，
不因它是流程或没有新信息就删减。不以镜头数量、平均镜长或运镜次数判质量；已接受的节奏与
审美目的优先，只有指出具体职责落空或约束冲突，才提出修订。
这些判断落入现有镜头职责与时长，不新增计划表。
