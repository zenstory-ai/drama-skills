...
- 核对人物、道具、门窗、屏幕与控件的相对位置、比例、方向和结构，没有把构图参考误当成新地理；
- 核对可辨文字、近似字形、号码、标牌、界面、水印和字幕残留；
- 若参考绑定到一个场景或起始帧，逐项对照该时刻允许出现的信息与状态。后续才完成的认证标记、标题、
  进度终值、开关结果、损伤或内容物不能提前泄露；结束态也不能倒灌为起始态。
...
- 起始帧已经出现后续才成立的认证、完成读数或内容物，或参考图中的屏幕方向、控件布局、门窗/物件
  结构与当前视觉设定冲突；
