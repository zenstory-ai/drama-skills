...
- **引文是认领，不是背景。** 「来源」里引了哪一句，就等于说这一镜负责拍它。引一个本镜画面里
  根本没有的人做的动作——把「另一个人低头去翻自己的稿子」写进一个只拍某一个人的特写——
  那个动作就从所有人的清单上消失了：没有别的镜头认领它，也没有任何一步报它缺失，
  于是它根本不会被拍出来，而这个缺口只有等人看完成片、问「他的反应呢」才浮出来。
  确实看不见就在「视觉依据」末尾写 `；画外：<类别>「<名称>」`，机械核对认这个写法。
